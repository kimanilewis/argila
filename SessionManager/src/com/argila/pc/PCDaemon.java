 ...
 */
public final class PCDaemon implements Daemon, Runnable {
    ...
    public void init(final DaemonContext context) throws DaemonInitException {
        try {
            ...
            log.info(CoreUtils.getLogPreString() + "init() |"
                    + " Initializing SessionManager daemon...");
    ...
    public void start() {
        working = true;
        worker.start();
        log.info("Starting Session Manager daemon...");
    }
    ...
    public void stop() {
        log.info("Stopping Session Manager daemon...");
        ...
        log.info("SessionManager Daemon stopped.");
    }
    ...
    @Override
    public void destroy() {
        log.info("Destroying SessionManager daemon...");
        log.info("Exiting...");
    }
