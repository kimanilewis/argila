package com.cellulant.CoreBroadcastProcessor.db;
...
/**
 * MySQL handler class for database reads and writes.
 *
...
public final class MySQL {
    ...
    public MySQL(final String host, final String port, final String database,
            ...
            final int maxConnections) throws ClassNotFoundException,
    ...
    private void setupDriver(final String connectURI, final int maxConnections)
         ...
         *           object when the pool is exhausted and whenExhaustedAction
        ...
        ObjectPool<PoolableConnectionFactory> connectionPool
                = new GenericObjectPool<>(null, maxConnections,
                        GenericObjectPool.WHEN_EXHAUSTED_BLOCK, 30000, true,
                        true);
         ...
         *
         * connectionFactory - the ConnectionFactory from which to obtain base
         ...
         *                   KeyedObjectPools for pooling PreparedStatements, or
         *                   null to disable PreparedStatement pooling
         ...
         * "jdbc:apache:commons:dbcp:poolName" to access our pool of
         * Connections.
         */
    }
    ...
    /**
     * <p>Gets a MySQL database connection. Will throw an SQLException if there
     * is an error. The connection uses UTF-8 character encoding.</p>
     *
